...
#         log_findings = log_analysis["findings"]
...
#         ai_input = "\n".join(important_lines[:50]) if important_lines else text[:1200]
...
#     log_analysis = analyze_logs(query)
#     log_insights = log_analysis["insights"]
#     log_findings = log_analysis["findings"]
...
#     ai_input = "\n".join(important_lines[:50]) if important_lines else query[:1200]
