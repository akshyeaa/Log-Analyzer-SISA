...
def test_calculate_risk_critical_risk_level():
    findings = [{"risk": "critical"}]
    log_insights = None
    score, level = calculate_risk(findings, log_insights)
    assert score == 5
...
def test_calculate_risk_high_risk_level():
    findings = [{"risk": "high"}, {"risk": "high"}]
    log_insights = None
    score, level = calculate_risk(findings, log_insights)
    assert score == 6
    assert level == "high"

def test_calculate_risk_medium_risk_level():
    findings = [{"risk": "medium"}]
    log_insights = None
    score, level = calculate_risk(findings, log_insights)
    assert score == 2
...
def test_calculate_risk_low_risk_level():
    findings = [{"risk": "low"}]
    log_insights = None
    score, level = calculate_risk(findings, log_insights)
    assert score == 1
...
def test_calculate_risk_score_above_10():
    findings = [{"risk": "critical"} for _ in range(3)]
    log_insights = None
    score, level = calculate_risk(findings, log_insights)
    assert score == 15
    assert level == "critical"

def test_calculate_risk_score_above_6():
    findings = [{"risk": "critical"}]
    log_insights = ["unauthorized"]
    score, level = calculate_risk(findings, log_insights)
    assert score == 10
...
def test_calculate_risk_score_above_3():
    findings = [{"risk": "medium"}]
    log_insights = ["unknown ip"]
    score, level = calculate_risk(findings, log_insights)
    assert score == 5
...
def test_calculate_risk_score_below_3():
    findings = [{"risk": "low"}]
    log_insights = None
    score, level = calculate_risk(findings, log_insights)
    assert score == 1
